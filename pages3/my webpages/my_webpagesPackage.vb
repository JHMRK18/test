...
<Guid(my_webpagesPackage.PackageGuidString)>
Public NotInheritable Class my_webpagesPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "507bb323-4a81-4730-a6c9-b33911cbc59d"
